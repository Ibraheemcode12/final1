...
public class UserController {
  ...
  @GetMapping("/username")
  public ResponseEntity<userdto> getUser(@RequestHeader("Username") String username) {
    return new ResponseEntity<userdto>(dataService.get_user(username),HttpStatus.OK);
  }
